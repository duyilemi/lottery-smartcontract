from brownie import network, accounts, config, MockV3Aggregator, Contract, MockV3Aggregator, VRFCoordinatorMock, LinkToken
...
def fund_with_link(
    ...
    transc = link_token.transfer(contract_address, amount, {"from": account})
    # another way ifyou want to work with the interface ...
